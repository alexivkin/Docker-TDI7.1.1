...
image_file='image/SLES_11_SP4_JeOS.x86_64-0.1.3.raw'
image_arch='x86_64'
schema_ver='5.2'
base_system='SLES11_SP4'
uefi_enabled='false'
declare -a repos=("SLE 11 SP4 SDK x86_64" "SLE 11 SP4 SDK Updates x86_64" "SLES 11 SP4 x86_64" "SLES 11 SP4 Updates x86_64")
